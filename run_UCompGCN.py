...
if __name__ == '__main__':
    ...
    parser.add_argument('-seed',        dest='seed',
                        default=41504,  type=int,     	help='Seed for randomization')
    ...
    parser.add_argument('-depth',		dest='depth',		default=1,
                        type=int,		help='The depth of the U-Net architecture')
    parser.add_argument('-pool_ratios',	dest='pool_ratios', default=0.5,
                        type=float,		help='Graph pooling ratio for each depth')
    parser.add_argument('-sum_res',		dest='sum_res', 	action='store_false',
                        help='If set to False, will use concatenation for integration of skip connections instead summation')
